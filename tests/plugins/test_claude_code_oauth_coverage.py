...
@pytest.mark.xdist_group(name="network")
    def test_no_shutdown_callback_registered(self):
        ...
        importlib.import_module(
            "code_puppy.plugins.claude_code_oauth.register_callbacks"
        )
        ...
        # No claude_code_oauth callback should be registered for shutdown
        assert not any("claude_code_oauth" in m for m in callback_modules), (
