...
@pytest.fixture
def fresh_bridge_with_turbo_parse(mock_turbo_parse_available: mock.MagicMock) -> Generator:
...
class TestTurboParseAvailablePath:
    ...
    def test_bridge_shows_available_when_module_present(self, mock_turbo_parse_available):
...
class TestTurboParseFallbackPath:
    ...
    def test_bridge_shows_unavailable_when_module_absent(self, fresh_bridge_without_turbo_parse):
    ...
    def test_extract_symbols_from_file_returns_error_stub(self, fresh_bridge_without_turbo_parse):
    ...
    def test_extract_syntax_diagnostics_returns_error_stub(self, fresh_bridge_without_turbo_parse):
    ...
    def test_parse_files_batch_returns_error_stub(self, fresh_bridge_without_turbo_parse):
        ...
        for r in result["results"]:
            ...
            assert "not available" in str(r.get("errors", [{}])[0].get("message", "")).lower()
    
    def test_health_check_returns_unavailable_status(self, fresh_bridge_without_turbo_parse):
    ...
    def test_is_language_supported_returns_false(self, fresh_bridge_without_turbo_parse):
    ...
    def test_is_turbo_parse_enabled_returns_false_when_unavailable(self, fresh_bridge_without_turbo_parse):
    ...
    def test_get_turbo_parse_status_when_unavailable(self, fresh_bridge_without_turbo_parse):
...
class TestPluginStartupBehavior:
    ...
    def test_startup_logs_when_module_available(self, caplog, mock_turbo_parse_available):
        ...
        with mock.patch("code_puppy.plugins.turbo_parse.register_callbacks.is_turbo_parse_available") as mock_avail:
        ...
        availability_logs = [r for r in caplog.records if "available" in r.message.lower()]
    ...
    def test_startup_logs_fallback_when_module_unavailable(self, caplog):
        ...
        assert any("not available" in r.message.lower() or "fallback" in r.message.lower() 
                  for r in caplog.records)
    
    def test_startup_handles_import_error_gracefully(self, caplog, mock_turbo_parse_available):
        ...
        with mock.patch("code_puppy.plugins.turbo_parse.register_callbacks.is_turbo_parse_available") as mock_avail:
            ...
            with mock.patch("builtins.__import__", side_effect=ImportError("Simulated import error")):
...
class TestParseCodeToolBothPaths:
    ...
    def test_parse_code_tool_structure_always_available(self):
        ...
        from code_puppy.plugins.turbo_parse.register_callbacks import _register_tools, _register_parse_code_tool
    ...
    def test_parse_code_tool_fallback_response_structure(self, fresh_bridge_without_turbo_parse):
...
class TestPathConsistency:
    ...
    def test_result_structure_consistency(self):
        ...
        expected_keys = {
            ...
            "extract_syntax_diagnostics": ["diagnostics", "error_count", "warning_count"],
            "stats": ["total_parses", "average_parse_time_ms", "languages_used", 
                     "cache_hits", "cache_misses", "cache_evictions", "cache_hit_ratio"],
        ...
        functions = {
            ...
            "extract_symbols_from_file": lambda: extract_symbols_from_file("/tmp/test.py"),
            "extract_syntax_diagnostics": lambda: extract_syntax_diagnostics("def test(): pass", "python"),
            "stats": stats,
