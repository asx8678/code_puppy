...
def test_version_smoke() -> None:
    child = pexpect.spawn("fast-puppy --version", encoding="utf-8")
...
def test_help_smoke() -> None:
    child = pexpect.spawn("fast-puppy --help", encoding="utf-8")
...
def test_interactive_smoke() -> None:
    ...
    """
    child = pexpect.spawn("fast-puppy -i", encoding="utf-8")
