...
class TestAgentManagerBasics:
    ...
    def test_load_agent_not_found(self):
        ...
        with patch("code_puppy.agents.agent_manager._discover_agents"):
            ...
            # The actual behavior is that it tries to fallback to fast-puppy
    ...
    def test_load_agent_fallback_to_code_puppy(
        ...
        """Test fallback to fast-puppy agent when requested agent not found."""

        # Setup registry with only fast-puppy
        class CodePuppyAgent(MockAgent):
            def __init__(self):
                super().__init__()
                self._name = "fast-puppy"
