...
-file("src/python_parser.erl", 210).
...
yeccpars2_20(S, 'import', Ss, Stack, T, Ts, Tzr) ->
...
yeccpars2_42(S, 'newline', Ss, Stack, T, Ts, Tzr) ->
...
yeccgoto_parameters(24, Cat, Ss, Stack, T, Ts, Tzr) ->
...
yeccgoto_simple_stmt(0=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_3(_S, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_simple_stmt(2=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_3(_S, Cat, Ss, Stack, T, Ts, Tzr).
...
yeccpars2_22_(__Stack0) ->
 ...
 [begin
                                                   {from_import, line(___1), unwrap(___2), unwrap(___4)}
  end | __Stack].
...
-file("src/python_parser.yrl", 41).
yeccpars2_41_(__Stack0) ->
 [___6,___5,___4,___3,___2,___1 | __Stack] = __Stack0,
 [begin
                                                      
    {class, line(___1), unwrap(___2), ___4}
  end | __Stack].
