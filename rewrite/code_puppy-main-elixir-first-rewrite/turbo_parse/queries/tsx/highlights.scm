;;; TSX Highlights Query
;;; Source: Helix Editor (https://github.com/helix-editor/helix)
;;; Merged from: ecma/highlights.scm + _typescript/highlights.scm + _jsx/highlights.scm + tsx/highlights.scm
;;; License: MPL-2.0 (Helix Editor queries are MIT compatible)
