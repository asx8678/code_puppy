...
def _on_create_file(*args, **kwargs):
...
def _on_replace_in_file(*args, **kwargs):
    set_flag(WorkflowFlag.DID_EDIT_FILE)
    set_flag(WorkflowFlag.DID_GENERATE_CODE)
...
def register_callback_handlers():
    ...
    # File operations
    callbacks.register_callback("create_file", _on_create_file)
    callbacks.register_callback("edit_file", _on_edit_file)
    callbacks.register_callback("replace_in_file", _on_replace_in_file)
...
def unregister_callback_handlers():
    ...
    callbacks.unregister_callback("create_file", _on_create_file)
    callbacks.unregister_callback("edit_file", _on_edit_file)
    callbacks.unregister_callback("replace_in_file", _on_replace_in_file)
