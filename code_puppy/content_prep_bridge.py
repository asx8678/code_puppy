...
def _python_format_line_numbers(
    ...
    Delegates to existing file_display implementation for DRY compliance.
    """
...
def format_line_numbers(
    ...
    """
    if RUST_AVAILABLE:
        return _rust_format_line_numbers(
            content, start_line, max_line_length, line_number_width
        )

    return _python_format_line_numbers(
        content, start_line, max_line_length, line_number_width
    )
