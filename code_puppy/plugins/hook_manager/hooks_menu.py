...
from both global (~/.fast_puppy/hooks.json) and project (.claude/settings.json) sources.
...
class HooksMenu:
    ...
    def _render_list(self) -> list:
        ...
        if not self.entries:
            ...
            lines.append(("", "\n"))
            lines.append((_C_DIM, "  or ~/.fast_puppy/hooks.json (global)"))
            lines.append(("", "\n\n"))
