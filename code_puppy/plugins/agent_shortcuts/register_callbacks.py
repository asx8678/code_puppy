...
def _get_custom_help() -> list[tuple[str, str]]:
    ...
    return [
        ...
        ("pack", "Switch to the pack-leader agent (requires pack agents enabled)"),
    ]
...
def _handle_pack_command() -> bool:
    """Handle /pack command - switch to pack-leader."""
    group_id = str(uuid.uuid4())
