...
class StagedChangesSandbox:
    ...
    def add_create(self, file_path: str, content: str, description: str = "") -> StagedChange:
    ...
    def add_replace(self, file_path: str, old_str: str, new_str: str, description: str = "") -> StagedChange:
    ...
    def add_delete_snippet(self, file_path: str, snippet: str, description: str = "") -> StagedChange:
    ...
    def _generate_change_id(self) -> str:
        ...
        return hashlib.sha256(f"{time.time()}{len(self._changes)}".encode()).hexdigest()[:12]
    ...
    def _diff_for_replace(self, change: StagedChange) -> str:
        ...
        if os.path.exists(change.file_path):
            with open(change.file_path, "r", encoding="utf-8", errors="surrogateescape") as f:
...
def stage_replace(file_path: str, old_str: str, new_str: str, description: str = "") -> StagedChange:
    """Stage a text replacement."""
    return get_sandbox().add_replace(file_path, old_str, new_str, description)


def stage_delete_snippet(file_path: str, snippet: str, description: str = "") -> StagedChange:
    """Stage a snippet deletion."""
