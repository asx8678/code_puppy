...
You are helping a user create hooks for Fast Puppy. Fast Puppy has two hook systems:
...
Configure shell commands responding to Fast Puppy events in `.claude/settings.json`:
